...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 15.57
  #define DEFAULT_Ki 1.86
  #define DEFAULT_Kd 32.53
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 49.87
  #define DEFAULT_bedKi 5.64
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 1500, 80, 10000 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.95 // Z offset: -below +above  [the nozzle]
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), Y_MAX_POS, 20 }
