...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 4.19
  #define DEFAULT_Ki 0.25
  #define DEFAULT_Kd 17.77
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 101.36
  #define DEFAULT_bedKi 19.49
  #define DEFAULT_bedKd 131.77
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_Z_RAISE_WHEN_OFF_MESH 3.6 // When the nozzle is off the mesh, this value is used
